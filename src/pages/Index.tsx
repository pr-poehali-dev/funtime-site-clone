...
const DONATE_ITEMS: DonateItem[] = [
  ...
  { id: 3, name: 'Герой', price: 24, image: '/img/67c5133c-b633-474c-b7b1-9fa03f2e3069.jpg', description: 'Префикс [Герой], /kit Герой, /top, /hat • 2 дома, 2 региона (Гриф 50k), 8 слотов аукциона', features: ['Все из Страж', '/hat команда', '5 домов'] },
  { id: 4, name: 'Аспид', price: 56, image: '/img/fd26bc25-073b-4cc9-b7f9-db6bfc16dc8d.jpg', description: 'Префикс [Аспид], /kit Аспид, /clear, /feed, /heal, /me • 2 дома, 2 региона (Гриф 60k), 9 слотов аукциона', features: ['Все из Герой', '/fly полёт', '10 домов'] },
  { id: 5, name: 'Сквид', price: 69, image: '/img/67c5133c-b633-474c-b7b1-9fa03f2e3069.jpg', description: 'Префикс [Сквид], /kit Сквид, /back, /ec, /wbench, /name • 3 дома, 3 региона (Гриф 75k), 10 слотов', features: ['Все из Аспид', 'Эффекты', '15 домов'] },
  { id: 6, name: 'Глава', price: 87, image: '/img/fd26bc25-073b-4cc9-b7f9-db6bfc16dc8d.jpg', description: 'Префикс [Глава], /kit Глава, /bc, /ext, /msgtoggle, /feed Ник, /heal Ник, /exp • 3 дома, 3 региона', features: ['Все из Сквид', 'Приватные варпы', '20 домов'] },
  { id: 7, name: 'Элита', price: 149, image: '/img/67c5133c-b633-474c-b7b1-9fa03f2e3069.jpg', description: 'Префикс [Элита], /kit Элита, /time, /weather, /loom, /beezooka, /firework • 3 дома, 5 регионов 150k, 12 слотов', features: ['Все из Глава', 'Уникальный префикс', '30 домов'] },
  { id: 8, name: 'Титан', price: 239, image: '/img/fd26bc25-073b-4cc9-b7f9-db6bfc16dc8d.jpg', description: 'Префикс [Титан], /kit Титан, /jump, /afk, /setwarp, /repair • 4 дома, 6 регионов 200k, 13 слотов', features: ['Все из Элита', 'Креатив', '50 домов'] },
  { id: 9, name: 'Принц', price: 329, image: '/img/67c5133c-b633-474c-b7b1-9fa03f2e3069.jpg', description: 'Префикс [Принц], /kit Принц, /smithtable, /stonecutter, /grindstone • 5 домов, 7 регионов 250k, 14 слотов', features: ['Все из Титан', 'Эксклюзивные команды', '75 домов'] },
  { id: 10, name: 'Князь', price: 549, image: '/img/fd26bc25-073b-4cc9-b7f9-db6bfc16dc8d.jpg', description: 'Префикс [Князь], /kit Князь, /fly, /amute, /enchant, /anvil, /speed, /salary • 7 домов, 10 регионов 350k', features: ['Все из Принц', 'Безлимит варпов', '100 домов'] },
  { id: 11, name: 'Герцог', price: 999, image: '/img/67c5133c-b633-474c-b7b1-9fa03f2e3069.jpg', description: 'Префикс [Герцог], /kit Крушитель, без задержки тп • 10 домов, 15 регионов 500k, вход на заполненный сервер', features: ['Все из Князь', 'Админ команды', 'Безлимит домов'] },
  { id: 12, name: 'Спонсор', price: 1850, image: '/img/fd26bc25-073b-4cc9-b7f9-db6bfc16dc8d.jpg', description: 'Префикс [Спонсор], /kit Спонсор, /зарплата, /exp • 15 домов, 20 регионов Анка, 20 слотов, без задержки тп', features: ['Все из Герцог', 'Особый статус', 'Все возможности'] },
  { id: 13, name: 'Мажор', price: 2650, image: '/img/67c5133c-b633-474c-b7b1-9fa03f2e3069.jpg', description: 'Команды Стажера-Хелпера • Все права модерации, максимальные возможности сервера', features: ['ТОП привилегия', 'Максимальные права', 'VIP поддержка'] }
];
